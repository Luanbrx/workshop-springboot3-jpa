...
import com.javaacademy.spring_learning_project.entities.*;
import com.javaacademy.spring_learning_project.repositories.*;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.CommandLineRunner;
import org.springframework.context.annotation.Configuration;
import org.springframework.context.annotation.Profile;
import com.javaacademy.spring_learning_project.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
    ...
    public  void run(String... argrs) throws  Exception{
        ...
        Payment pay1 = new Payment(null, Instant.parse("2026-06-20T19:53:07Z"), o1);
        o1.setPayment(pay1);
